...
export const POST_DELETE_BY_USER_REQUEST = "POST_DELETE_BY_USER_REQUEST";
export const POST_DELETE_BY_USER_SUCCESS = "POST_DELETE_BY_USER_SUCCESS";
export const POST_DELETE_BY_USER_FAIL = "POST_DELETE_BY_USER_FAIL";
